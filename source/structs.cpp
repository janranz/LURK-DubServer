...
uint16_t const  serverStats::PLAYER_MAX_STAT     = std::numeric_limits<unsigned short>::max();
int16_t  const  serverStats::PLAYER_S_MAX_STAT   = std::numeric_limits<short>::max();
uint8_t  const  serverStats::BASE_FLAGS          = 0b11000000;
